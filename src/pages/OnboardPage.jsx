...
export default function OnboardPage() {
  ...
  const assess = async () => {
    try {
      const r    = await fetch('https://api.coreidentity.coreholdingcorp.com/api/commercial/assess',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({industry:form.industry,agentCount:form.agentCount,currentScore:form.currentScore,company:form.company,email:form.email})});
