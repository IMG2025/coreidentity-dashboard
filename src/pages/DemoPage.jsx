...
function LiveFire() {
  ...
  const fire = async () => {
    ...
    try {
      const r    = await fetch('https://api.coreidentity.coreholdingcorp.com/api/agents/execute',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({clientId:a.cid,agentId:a.id,task:a.task,payload:{demo:true}})});
