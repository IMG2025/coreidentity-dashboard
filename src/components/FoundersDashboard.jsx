...
function AuditTrailView() {
  ...
  const fetchAudit = useCallback(async () => {
    try {
      const [execRes, statsRes] = await Promise.all([
        fetch('https://portal.coreidentitygroup.com/api/telemetry/executions?limit=100'),
        fetch('https://portal.coreidentitygroup.com/api/telemetry/stats')
      ]);
  ...
  useEffect(() => {
    fetch('https://portal.coreidentitygroup.com/api/telemetry/seed',{method:'POST',headers:{'Content-Type':'application/json'},body:'{}'})
  ...
  const fireAgent = async () => {
    ...
    try {
      ...
      const res    = await fetch('https://portal.coreidentitygroup.com/api/agents/execute',{
